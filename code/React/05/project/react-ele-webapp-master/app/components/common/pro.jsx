...
class Pro extends React.Component {
	...
	handelClick(id){
		 let name=JSON.stringify(this.props.data.name)
		 let url=JSON.stringify(this.props.data.image_path)
		console.log('this.props',this.props.data);
		console.log('name',name);
		console.log('url',url);
		hashHistory.push('/detail/'+id+'?qhfrom='+this.props.pagename+name+url)
